...
mp = plt.imread('graphics/ohio.png')

BBox = ((-84.2000, -84.0907, 39.5800, 39.6665)) # The boundaries for the map
fig, ax = plt.subplots(figsize = (8,7))
ax.scatter([-84.2000, -84.2000, -84.0907, -84.0907], [39.6665, 39.5800, 39.6665, 39.5800], zorder=1, alpha=0, c='steelblue', s=1)
...
ax.set_title('WEP Usage in Centerville, Ohio')
